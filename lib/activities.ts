...
export const ACTIVITY_PHASES: Record<ActivityId, PhaseId[]> = {
  ...
  // LinkedIn connections with mentors / guests - useful whenever the room is socialising.
...
export const BINGO_MISSIONS = [
  ...
  'High-five a mentor or volunteer',
  "Find an idea you'd actually invest in",
  'Find a team where someone is at their first event',
  'Discover a team with all-women members',
  'Find a team building hardware',
  'Find a team building a mobile app',
  'Find an idea solving a problem in your own city',
  'Pitch your idea to a team from a totally different field',
