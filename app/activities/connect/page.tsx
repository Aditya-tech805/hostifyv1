 ...
 * /activities/connect
 *
 * Curated list of seniors / mentors in the room. Each card opens their
 * LinkedIn profile in a new tab. List is coordinator-managed from
 * /console -> "Seniors panel" so it can be edited live (e.g. when a
    ...
    <>
      ...
      <main className="mx-auto max-w-[820px] px-5 pb-20 pt-6">
        <ActivityHeader
          ...
          description="Seniors and mentors in the room have agreed to be reached out to. Tap a card to open their LinkedIn profile and send a connection request before the day ends."
        />
    ...
    return (
      <div className="mt-8 rounded-2xl border border-dashed border-line-2 bg-surface p-10 text-center">
        ...
        <p className="text-[15px] leading-relaxed text-ink-2">
          The seniors list is being <span className="font-serif italic font-light text-accent">finalised</span> by the coordinator.
          <br />
